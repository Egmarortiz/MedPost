...
# --- Make "app/..." importable (project_root on sys.path) ---
sys.path.append(os.path.dirname(os.path.dirname(__file__)))

# Import your models' Base so autogenerate can see tables
from app.models import Base

# --- Alembic Config object ---
config = context.config  # <-- define this BEFORE using it

# Option A: read URL from env var (takes precedence if set)
